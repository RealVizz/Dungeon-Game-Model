...
public class DungeonTest {
  ...
  List<Treasure> emptyTreasureList = new ArrayList<Treasure>();
  ...
  public void invalidRowCountTest1() {
    try {
      new Dungeon("0x2", "0,0", "1,1", 20, 0, p1, false);
      Assert.fail();
  ...
  public void invalidRowCountTest2() {
    try {
      new Dungeon("-1x2", "0,0", "1,1", 20, 0, p1, false);
      Assert.fail();
    } catch (IllegalArgumentException e) {
      Assert.assertTrue(true);
    }
  ...
  public void invalidColCountTest1() {
    try {
      new Dungeon("2x0", "0,0", "1,1", 20, 0, p1, false);
      Assert.fail();
    } catch (IllegalArgumentException e) {
      Assert.assertTrue(true);
    }
  ...
  public void invalidColCountTest2() {
    try {
      new Dungeon("1x-2", "0,0", "1,1", 20, 0, p1, false);
      Assert.fail();
    } catch (IllegalArgumentException e) {
      Assert.assertTrue(true);
    }
  ...
  public void invalidStartRowTest1() {
    try {
      new Dungeon("2x2", "-1,0", "1,1", 20, 0, p1, false);
      Assert.fail();
    } catch (IllegalArgumentException e) {
      Assert.assertTrue(true);
    }
  ...
  public void invalidStartRowTest2() {
    try {
      new Dungeon("2x2", "777,0", "1,1", 20, 0, p1, false);
      Assert.fail();
    } catch (IllegalArgumentException e) {
      Assert.assertTrue(true);
    }
  ...
  public void invalidStartColumnTest1() {
    try {
      new Dungeon("2x2", "0,-1", "1,1", 20, 0, p1, false);
      Assert.fail();
    } catch (IllegalArgumentException e) {
      Assert.assertTrue(true);
    }
  ...
  public void invalidStartColumnTest2() {
    try {
      new Dungeon("2x2", "0,777", "1,1", 20, 0, p1, false);
      Assert.fail();
    } catch (IllegalArgumentException e) {
      Assert.assertTrue(true);
    }
  ...
  public void invalidEndRowTest1() {
    try {
      new Dungeon("2x2", "0,0", "-4,1", 20, 0, p1, false);
      Assert.fail();
    } catch (IllegalArgumentException e) {
      Assert.assertTrue(true);
    }
  ...
  public void invalidEndColumnTest1() {
    try {
      new Dungeon("1x2", "0,0", "1,-4", 20, 0, p1, false);
      Assert.fail();
    } catch (IllegalArgumentException e) {
      Assert.assertTrue(true);
    }
  ...
  public void invalidTreasurePercentageTest1() {
    try {
      new Dungeon("5x5", "0,0", "1,1", -20, 0, p1, false);
      Assert.fail();
    } catch (IllegalArgumentException e) {
      Assert.assertTrue(true);
    }
  ...
  public void invalidTreasurePercentageTest2() {
    try {
      new Dungeon("5x5", "0,0", "1,1", 200, 0, p1, false);
      Assert.fail();
    } catch (IllegalArgumentException e) {
      Assert.assertTrue(true);
    }
  ...
  public void impossibleLength5Constraint() {
    try {
      new Dungeon("1x2", "0,0", "0,0", 20, 0, p1, false);
      Assert.fail();
    } catch (IllegalArgumentException e) {
      Assert.assertTrue(true);
    }
  ...
  public void invalidInterconnectivity() {
    try {
      new Dungeon("6x9", "0,0", "0,0", 20, -1, p1, false);
      Assert.fail();
    } catch (IllegalArgumentException e) {
      Assert.assertTrue(true);
    }
  ...
  public void tooHighInterConnectivity() {
    try {
      new Dungeon("6x9", "0,0", "6,9", 20, 180, p1, false);
      Assert.fail();
    } catch (IllegalArgumentException e) {
      Assert.assertTrue(true);
    }
  ...
  public void pathLengthCheck() {
    try {
      new Dungeon("6x9", "0,0", "6,9", 20, 0, p1, false);
      Assert.fail();
    } catch (IllegalArgumentException e) {
      Assert.assertTrue(true);
    }
  ...
  public void interconnectivityTest1() {
    ...
    int treasurePerc = 20;
    Dungeon d = new Dungeon("5x5", "0,0", "3,3", treasurePerc,
            interconnectivity, p1, false);
  ...
  public void interconnectivityTest2() {
    ...
    int treasurePerc = 20;
    Dungeon d = new Dungeon("50x50", "0,0", "3,3", treasurePerc,
            interconnectivity, p1, false);
    int totalEdges = d.getDungeonEdges().size();
    Assert.assertEquals(d.getTotalNodes() + interconnectivity - 1, totalEdges);
  }
